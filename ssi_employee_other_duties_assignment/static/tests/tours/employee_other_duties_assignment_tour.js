odoo.define("ssi_employee_other_duties_assignment.employee_other_duties_assignment_tour", function (require) {
    "use strict";
    ...
    tour.register(
        ...
        [].concat(openEodaListSteps(), [
            ...
            },
            {
                ...
                trigger: ".ui-autocomplete .ui-menu-item a:contains(Tour EODA Type)",
                in_modal: false,
            },
            {
    ...
    tour.register(
        ...
        [].concat(openEodaListSteps(), [
            // ── Flow 2 — Find and open the record to edit.
            {
                ...
                trigger: ".o_data_row:contains(Tour EODA Employee Edit) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                trigger: ".o_form_view",
